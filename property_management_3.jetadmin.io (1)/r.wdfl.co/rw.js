/*! Build 9fd856878384c3ce147e9182075a70ffaf3996a0:1713865601935 */ ! function(e) {
    var t = {};
    ...
    }, r.p = "https://cdn.getrewardful.com/packs/", r(r.s = 75)
}({
    7: function(e, t, r) {
        var n, o, a;
    ...
    75: function(e, t, r) {
        ...
        var w = function() {
                ...
                return t = e, n = [{
                    ...
                    value: function(t) {
                        var r = e.get().id;
                        return h("POST", D.config.API_HOST + "/referrals/".concat(r, "/convert"), t)
                    }
                }, {
                    key: "load",
                    value: function(e) {
                    ...
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            t = D.config.API_HOST + "/referrals/track";
                        return h("POST", t, e)
                    }
            ...
            return t = e, (r = [{
                ...
                get: function() {
                    ...
                    if (this._location && this._location.search) {
                        var t = D.paramNames.map((function(t) {
                            return O(e._location.search, new RegExp("".concat(t, "=([a-z0-9-]+)"), "i"))
                        })).filter((function(e) {
                            return !1 !== e
                        }));
                ...
                get: function() {
                    ...
                    if (this._location && this._location.hash) {
                        var t = D.paramNames.map((function(t) {
                            return O(e._location.hash, new RegExp("".concat(t, "[-=]([a-z0-9-]+)"), "i"))
                        })).filter((function(e) {
                            return !1 !== e
                        }));
                        return t.length > 0 && t[0]
        ...
        var P = function(e, t, r) {
            ...
            R = function() {
                ...
                return t = e, n = [{
                    ...
                    value: function(e) {
                        var t = {
                            referral: P(e, e.dataset.rewardfulParamName || "referral", D.referral)
                        };
                        return D.coupon && D.coupon.id && (t.coupon = P(e, "coupon", D.coupon.id)), t
                    }
        ...
        var S = function() {
            ...
            }], (r = null) && E(t.prototype, r), n && E(t, n), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
        ...
        var A = function() {
                ...
                }], (r = null) && T(t.prototype, r), n && T(t, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), e
            }(),
            N = function() {
        ...
        var K = function() {
            ...
            return t = e, n = [{
                ...
                key: "setup",
                value: function(e) {
                    return this._setup ? (console.warn("Rewardful is already setup."), !1) : e ? e.apiKey ? e.window ? (N(), this._apiKey = e.apiKey.replace(/[^A-Za-z0-9-_]/g, ""), this._paramNames = e.paramNames, this._link = new _(e.window.location), this._setup = !0, this._metadata = {
                        api_key: this.apiKey,
                ...
                get: function() {
                    return {
                        timestamp: 1713865601935,
                        sha: "9fd856878384c3ce147e9182075a70ffaf3996a0"
                    }
                }
            }, {
                key: "_cookie",
            ...
            }], (r = null) && q(t.prototype, r), n && q(t, n), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
        K.Forms = R, K.Links = k, K.BuyButtons = S, K.PaymentLinks = x, K.PricingTables = A, K.reset();
        var D = K;
        ...
        ! function() {
            if (window && window._rewardful_loaded) console.warn("Rewardful is already loaded.");
                ...
                try {
                    ...
                    if (e) {
                        window.Rewardful = D, D.setup({
                            apiKey: e.getAttribute("data-rewardful"),
                            paramNames: e.getAttribute("data-rewardful-params"),
                            window: window
                        });
                        var t = function() {
                                D.Forms.attach(), D.BuyButtons.attach(), D.PaymentLinks.attach(), D.PricingTables.attach(), D.Links.attach({
                                    domains: e.getAttribute("data-domains"),
                                    location: window.location
                                })
                            },
                            r = new I(window, window._rwq || "rewardful", D);
