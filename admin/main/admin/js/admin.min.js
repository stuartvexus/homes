...
$('.print-orders').click(function(){
  ...
  page.innerHTML = $('.all-orders').html()
  window.print()
})
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-5 col-md-5 col-sm-6">
									<input type="file" id='property-detail-image'  style="display:none;">
									<div class="white-box text-center" id="property-image-view">
									${property.images.length > 0 ? 
										`
										<img id="previewImage" src="${property.images[0].includes('http') ? property.images[0].replace('http://localhost:8000',server_url) : server_url+"/"+property.images[0]}" alt="Image" class="img-responsive"/>		
										`
								...
								<div class="col-lg-7 col-md-7 col-sm-6">
									...
									<button class="btn btn-primary btn-rounded delete-property" onclick="Service.del('properties','${property.property_id}')">Delete property</button>
...
Service.addImages = (e) =>{
  console.log(e.files,e.target)
  for(var e of e.files){
    Service.imageFiles.push("uploads/"+e.name)
  }
}
...
$("#property-detail-image").change(function(event){
